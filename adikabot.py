...
def main():
    ...
    # drop_pending_updates=True: ቦቱ እንደገና ሲነሳ ካለፈው session የተከማቹ updates ችላ ይላል፣
    # ይህም ከ restart በኋላ ከሚፈጠር ጊዜያዊ getUpdates conflict ይረዳል።
    # ማስታወሻ፦ ይህ conflict ስህተትን ሙሉ በሙሉ አያስወግድም — ዋናው መንስኤ ሁለት bot instances
    # በትይዩ (parallel) እየሮጡ ከሆነ ነው፤ ያንን ማረጋገጥ ያስፈልጋል።
