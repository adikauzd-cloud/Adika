...
# ==============================================================================
# 0. FLASK WEB SERVER (For Keep-Alive/Render/Heroku)
# ==============================================================================
...
# ==============================================================================
# 3. KEYBOARDS & UNIQUE CONVERSATION STATES
# ==============================================================================
MAIN_KEYBOARD = [
...
# Unique States to prevent any overlap issues
(
    # Broker Reg States (10-12)
    BROKER_NAME, BROKER_PHONE, BROKER_AREA,
    
    # Market Flow States (20-38)
    FLOW_ROLE, FLOW_CAT,
...
async def support_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "ማንኛውም ጥያቄ ወይም አስተያየት ካለዎት በደስታ እንረዳዎታለን፦\n\n"
        "📱 **ስልክ:** +251 900 000 000\n"
        "💬 **ቴሌግራም:** @AdikaSupport",
        parse_mode="Markdown"
    )
...
async def sell_house_area_received(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🏗️ **የቤቱ/የቦታው ሁኔታ ያስገቡ (ምሳሌ፦ ያለቀለት፣ ያላበቃ)፦**", parse_mode="Markdown")
...
async def finalize_listing(update: Update, context: ContextTypes.DEFAULT_TYPE, cat, formatted_desc, photo_id=None):
    ...
    if req_id:
        ...
        if update.message:
            await update.message.reply_text(reply_msg, reply_markup=ReplyKeyboardMarkup(MAIN_KEYBOARD, resize_keyboard=True), parse_mode="Markdown")
        elif update.callback_query:
            await update.callback_query.message.reply_text(reply_msg, reply_markup=ReplyKeyboardMarkup(MAIN_KEYBOARD, resize_keyboard=True), parse_mode="Markdown")
...
def main():
    ...
    app.add_handler(MessageHandler(filters.Regex("^📞 ድጋፍ$"), support_handler))

    # Broker Registration Conversation Handler
    ...
    # Response Flow Conversation Handler
    ...
    # Main Market Flow Conversation Handler
    ...
    print("🚀 Adika Marketplace Bot ያለ ምንም ችግር ስራ ጀምሯል...")
    app.run_polling()
