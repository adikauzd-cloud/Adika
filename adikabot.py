...
BROKER_NAME, BROKER_PHONE, BROKER_LOCATION = range(23, 26)
...
def main():
    ...
    car_buyer_conv = ConversationHandler(
        ...
        states={
            ...
            CAR_BUYER_CONFIRM: [CallbackQueryHandler(confirm_handler, pattern="^confirm_"), 
                              MessageHandler(filters.TEXT & ~filters.COMMAND, car_buyer_confirm), cancel_message_handler],
        },
    ...
    car_seller_conv = ConversationHandler(
        ...
        states={
            ...
            CAR_SELLER_CONFIRM: [CallbackQueryHandler(confirm_handler, pattern="^confirm_"), 
                               MessageHandler(filters.TEXT & ~filters.COMMAND, car_seller_confirm), cancel_message_handler],
        },
        fallbacks=[CommandHandler("start", start), cancel_message_handler],
        allow_reentry=True,
    )
    ...
    house_buyer_conv = ConversationHandler(
        ...
        states={
            ...
            HOUSE_BUYER_CONFIRM: [CallbackQueryHandler(confirm_handler, pattern="^confirm_"), 
                                MessageHandler(filters.TEXT & ~filters.COMMAND, house_buyer_confirm), cancel_message_handler],
        },
        fallbacks=[CommandHandler("start", start), cancel_message_handler],
        allow_reentry=True,
    )
    ...
    house_seller_conv = ConversationHandler(
        ...
        states={
            ...
            HOUSE_SELLER_CONFIRM: [CallbackQueryHandler(confirm_handler, pattern="^confirm_"), 
                                 MessageHandler(filters.TEXT & ~filters.COMMAND, house_seller_confirm), cancel_message_handler],
        },
        fallbacks=[CommandHandler("start", start), cancel_message_handler],
        allow_reentry=True,
    )
